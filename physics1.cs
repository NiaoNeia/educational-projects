       ...
       public static float VvodChisla()
         ...
         class Snaryad
        {
            ...
            public void CoordinatesVelocity ()
            {
                ...
                Console.Out.WriteLine("Koordinaty {0} shara X = {1}, Y = {2}, Velocity V = {3}", count, NachalnayaCoordinataX, NachalnayaCoordinataY, Velocity);
            }
        }

        public static void Main(string[] args)
        {
            var Ball1 = new Snaryad(VvodChisla(), VvodChisla(), VvodChisla());
            Ball1.CoordinatesVelocity();
            var Pushka = new Snaryad(VvodChisla(), VvodChisla(), VvodChisla());
